            ...
            <div className="col-4">
                <div className="text-zone media-about">
                    ...
                    <div className="title"><h1 id="main-effect-header">
                        ABOUT ME</h1></div>
                    <p className="white">
                        Applying for a position Front-End developer. Student of the National Aviation University,
                        studying at the Faculty of Cybersecurity, computer and software engineering.
                    </p>
                    <p className="white">
                        I am fond of Web development for the past 3 years. I have good analytical skills. Easy to learn.
                        I work well in the team.
                    </p>
                    <p className="white">
